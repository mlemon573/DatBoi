...
public class Whiteboard extends JFrame {
   ...
   private void saveXml() {
      ...
      if (saveState == JFileChooser.APPROVE_OPTION) {
         ...
         try {
            XMLEncoder xmlOut = new XMLEncoder(new BufferedOutputStream(new FileOutputStream(file + ".xml")));
   ...
   /**
    * Sets the highlighted DText object's font when the selected item in the font JComboBox changes.
    */
   ...
   /**
    * Disable text controls if highlighted object is not null or is not a DText object.
    */
   private void textCheck() {
      if (!"Client".equals(canvas.getMode())
              && (canvas.getSelected() == null || canvas.getSelected() instanceof DText)) {
   ...
   /**
    * A CanvasListener class to detect mouse clicks and update the canvas accordingly.
    */
   ...
   /**
    * A CanvasMotionListener class to detect mouse movements and resize/move the selected shape.
    */
   ...
   /**
    * A TextChangeListener class to detect keyboard typing in the text box to update a DText object's text.
    */
